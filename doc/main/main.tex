...
Profile tools are used to present behaviour information attached to a 
...
\begin{itemize}
  ...
  \item CCCG
  \item Selecting points of interest in traces using patterns of events
\end{itemize}
