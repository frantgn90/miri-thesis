...
% TODO !!! Here I have to analize the complexity in terms of time of the
% presented algorithms. This is a key section since this is the reason because I
% wanted to research about using clustering instead these algorithms
