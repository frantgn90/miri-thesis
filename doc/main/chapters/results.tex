...
\begin{figure}
  \centering
  \includegraphics[width=0.3\textwidth]{validation/clustering_val_10}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{validation/lulesh_trace_1}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{validation/lulesh_trace_2}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{validation/lulesh_trace_3}
