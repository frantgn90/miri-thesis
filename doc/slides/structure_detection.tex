...
\captionsetup[pseudocode]{labelformat=empty}
...
\end{figure}
\begin{itemize}%[<+->]
	\item<2,7> Parsing and reducing information from trace
	\item<3,7> Identify loops by MPI call sites classification
	\item<4,7> Find out the hierarchical relations between loops
	\item<5> Colapse same MPI call site from different processes
	\item<6-> Construction of the output
\end{itemize}
\end{frame}
...
%	\end{pseudocode}
	\begin{figure}
		\includegraphics[width=0.45\textwidth]{imgs/clustering_ex_3_ps3.png}
	\end{figure}
	\begin{textblock*}{2cm}(135px,130px) % {block width} (coords)
	...
	\end{figure}
	\begin{figure}
		\includegraphics[width=0.15\textwidth]<6>{imgs/reduce_example_5.pdf}
	\end{figure}
	\vfill \null	
\end{multicols}
\end{frame}
...
\end{figure}
\begin{figure}
	\includegraphics[width=0.15\textwidth]{imgs/reduce_example_5.pdf}
\end{figure}	
\end{multicols}
\pause
\begin{block}{Keynote}
...
\begin{mdframed}[backgroundcolor=black!10,roundcorner=5pt,linewidth=0pt]
	...
	\textbf{Output} Set of clusters of MPI call sites $\rightarrow$ Loops
\end{mdframed}
\begin{multicols}{2}
%	\begin{pseudocode}{ }{ }
%		\FOR 1 \text{ to } 50 \DO
...
\framesubtitle{Pseudocode construction}
\begin{figure}
	\includegraphics[width=0.7\textwidth]<1>{imgs/example_output_2.png}
	\includegraphics[width=0.7\textwidth]<2>{imgs/example_output_2_2.png}
	\includegraphics[width=0.7\textwidth]<3>{imgs/example_output_2_3.png}
	\includegraphics[width=0.7\textwidth]<4>{imgs/example_output_2_4.png}
	\includegraphics[width=0.7\textwidth]<5>{imgs/example_output_2.png}
	%\caption{Example console output}
\end{figure}
\pause
\begin{figure}
	\includegraphics[height=0.3\textheight]<5>{imgs/interactive_shell_example.png}
\end{figure}
\end{frame}
...
\textbf{Clustering aliasing} $\rightarrow$ Same behavior
	\begin{multicols}{2}
		\begin{figure}
			\includegraphics[height=0.25\textheight]{imgs/aliasing_example_pse.png}
		\end{figure}
		\columnbreak
		\begin{figure}
			\includegraphics[width=0.25\textwidth]{imgs/aliasing_ex_clustering.png}
		\end{figure}
	\end{multicols}
\vfill
\pause
\textbf{Clustering split} $\rightarrow$ Data conditions
	\begin{multicols}{2}
		\begin{figure}
			\includegraphics[height=0.20\textheight]{imgs/split_example_2.png}
		\end{figure}
		\columnbreak
		\begin{figure}
			\includegraphics[width=0.25\textwidth]{imgs/clustering_val_8.png}
		\end{figure}
	\end{multicols}
\pause
\begin{block}{Keynote}
...
\begin{frame}
	...
	Execution:
	\begin{itemize}
		\item 6014 code lines (C++) (142 MPI calls)
		\item 125 parallel processes 
		%\item 30 iterations
		\item $\approx160MB$ tracefile
	\end{itemize}
	Analysis:
	\begin{itemize}
		\item Filter all $loops < 10\%$\\
...
\begin{figure}
	...
	\caption{Lulesh 2.0 125 MPI ranks -- 30 iterations}
\end{figure}
\end{frame}
...
\begin{frame}
	...
	\centering
	%\begin{figure}
	\includegraphics[width=0.8\textwidth]<1>{imgs/result_val_10_bursts_2.png}
	\includegraphics[width=0.8\textwidth]<2>{imgs/result_val_10_bursts_2_s1.png}
	\includegraphics[width=0.8\textwidth]<3>{imgs/result_val_10_bursts_2_s2.png}
	\includegraphics[width=0.8\textwidth]<4>{imgs/result_val_10_bursts_2_s3.png}
	\includegraphics[width=0.8\textwidth]<5>{imgs/result_val_10_bursts_2_s4.png}
	\includegraphics[width=0.8\textwidth]<6>{imgs/result_val_10_bursts_2_s5.png}\\
	%\end{figure}
	\vfill
	%\begin{figure}
		\includegraphics[width=0.6\textwidth]<1>{imgs/lulesh_trace_3.png}
		\includegraphics[width=0.6\textwidth]<2>{imgs/lulesh_trace_3_s1.png}
		\includegraphics[width=0.6\textwidth]<3>{imgs/lulesh_trace_3_s2.png}
		\includegraphics[width=0.6\textwidth]<4>{imgs/lulesh_trace_3_s3.png}
		\includegraphics[width=0.6\textwidth]<5>{imgs/lulesh_trace_3_s4.png}
		\includegraphics[width=0.6\textwidth]<6>{imgs/lulesh_trace_3_s5.png}
	%\end{figure}
\end{frame}
...
\begin{multicols*}{2}
		Execution:
		\begin{itemize}
			\item $\approx2000$ code lines (Fortran) (40 MPI calls)
...
%	\end{mdframed}
	\vfill
	\begin{figure}
		\includegraphics[width=0.4\textwidth,height=0.4\textheight]{imgs/plots/cg_red_and_trace.png}
	\end{figure}
	\vfill
	\begin{mdframed}[backgroundcolor=black!10,roundcorner=5pt,linewidth=0pt]
